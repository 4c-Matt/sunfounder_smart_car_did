...
# Client_Routine
#
# This code manages all the clientside code for the Sunfounder
# Smart Video Car v1
#
...
print "\nTo avoid errors, wait until the server session routine is actived and then press enter to continue \n"
...
raw_input("Press enter to CONNECT to the ROBOT CONTROL server once it is operating...\n")
